...
/* LAS REGLAS DE CARTON TIENEN QUE DECIR LO MISMO EN LOS DOS LADOS.
   ...
   Ahora la base tiene "GP2"._oc_validar_carton(p_items), que es un PORT LITERAL de
   famKey / famBase / reglaDe / gruposCarton / validarCarton, y crear_oc la llama.

   Este test corre los MISMOS 13 casos contra el JS de la pantalla y compara, mensaje por
   mensaje, con lo que devolvio la funcion de la base. Los ESPERADOS de abajo NO son lo que
   yo creo que deberia pasar: son la salida REAL de
