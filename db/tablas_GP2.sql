...
comment on column "GP2".proveedor_servicio.envio_uni_x is 'Cuantas unidades canonicas entran en una unidad de envio (envio_unidad). AJ Adhesivos = 100 (paquete de 100 pliegos), Ester = 1800 (bolsa de 1800 mangos). La Tablet muestra/precarga el sugerido dividido por este factor (redondeo para arriba) y al registrar multiplica de nuevo: el inventario siempre queda en la unidad canonica. NULL = el factor NO es uno solo para todo el proveedor, sale de cada pieza (componente.uni_x_cajon): con envio_unidad=''kg'' es Hernandez Julio (se pesa y el bulto va al lado, segun el sector), y con envio_unidad=''cajones'' + envio_carga_unidad=''kg'' son Guazzaroni Patricio y Jade (el sugerido se mira en cajones de esa pieza y la cantidad se escribe en kg). [usuario 2026-09-17/18]';
comment on column "GP2".proveedor_servicio.envio_carga_unidad is 'En QUE unidad se CARGA la cantidad al enviarle, cuando el proveedor tiene unidad de envio propia. NULL = se carga en la unidad de envio misma (AJ Adhesivos: el sugerido dice 3 paquetes y se escriben 3). ''kg'' = el sugerido se muestra en la unidad de envio y la cantidad se escribe en KG, con la equivalencia al lado. Dos sabores segun envio_uni_x: con factor unico es Ester (bolsas de 1800 mangos; 1 bolsa = 1800 x kg_x_uni = 9,72 kg) [usuario 2026-09-17]; SIN factor el envase es el CAJON de cada pieza (componente.uni_x_cajon) y son Guazzaroni Patricio [usuario 2026-09-17: "el sugerido tendria que aparecer en cajones y en cantidad pones kg y que te diga cuantos cajones son (redondeando)"] y Jade [usuario 2026-09-18: "el sugerido tiene que aparecer en cajones y la cantidad... pones los kilos y te tira cuantos cajones es el equivalente"]. El kg viaja tal cual a la base y to_canonical lo pasa a unidades con kg_x_uni: el inventario nunca ve bolsas ni cajones.';
